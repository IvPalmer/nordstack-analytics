"""Connection settings. Defaults match docker-compose.yml. The NORDSTACK_* variables are
the same ones profiles.yml reads; make exports them from .env to ingestion and dbt."""
import os
